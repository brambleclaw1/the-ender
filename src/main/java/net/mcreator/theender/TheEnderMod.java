...
@Mod("the_ender")
public class TheEnderMod {
	public static final Logger LOGGER = LogManager.getLogger(TheEnderMod.class);
	public static final String MODID = "the_ender";
