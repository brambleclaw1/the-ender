package net.mcreator.theender.procedures;
...
public class RenderSkiesProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, PoseStack pose) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation(("the_ender" + ":textures/" + "custom_end_sky" + ".png")));
